...
import { bakeCapitol, CAPITOL_ANCHOR_Y, CAPITOL_KEY, CAPITOL_SCALE } from "./textures/capitol/base";
import { CRANE_HEIGHT } from "./crane";
import { DIFF_SCAFFOLD_HEIGHT, DIFF_SCAFFOLD_KEY } from "./textures/scaffold";
import { HIGHLIGHT_KEY, SMOKE_KEY, RUBBLE_KEY, ADDED_MARKER_KEY, SELECT_KEY } from "./textures/effects";
import { ISSUE_SHOP_ANCHOR_Y, ISSUE_SHOP_KEY, bakeBuilding } from "./textures/buildings";
import { AIRPORT_TERMINAL_KEY, AIRPORT_TERMINAL_ANCHOR_Y, AIRPORT_TOWER_KEY, AIRPORT_TOWER_ANCHOR_Y } from "./textures/airport/terminal";
import { AIRPORT_APRON_KEY, AIRPORT_TAXIWAY_VERTICAL_KEY, AIRPORT_TAXIWAY_JUNCTION_KEY, AIRPORT_RUNWAY_TILE_KEY, AIRPORT_RUNWAY_THRESHOLD_KEY } from "./textures/airport/runway";
import { AIRPORT_WINDSOCK_KEY } from "./textures/airport/props";
import { AIRPLANE_KEY, AIRPLANE_SHADOW_KEY } from "./textures/airport/aircraft";
import { HARBOUR_QUAY_KEY, HARBOUR_QUAY_DECK, HARBOUR_QUAY_ANCHOR_Y, HARBOUR_PIER_KEY, HARBOUR_PIER_ANCHOR_Y, HARBOUR_WAREHOUSE_KEY, HARBOUR_WAREHOUSE_ANCHOR_Y, HARBOUR_BOLLARD_KEY, HARBOUR_SIGN_KEY, HARBOUR_SIGN_ANCHOR_Y, HARBOUR_LIGHTHOUSE_KEY, HARBOUR_LIGHTHOUSE_ANCHOR_Y, HARBOUR_LIGHTHOUSE_LAMP_Y, HARBOUR_LAMP_KEY, HARBOUR_LAMP_GLOW_Y, HARBOUR_MARKER_KEY, HARBOUR_MARKER_LAMP_Y } from "./textures/harbour/base";
import { HARBOUR_CRANE_KEY, HARBOUR_CRANE_ANCHOR_Y, HARBOUR_CRANE_JIB_KEYS, HARBOUR_CRANE_JIB_ORIGIN, HARBOUR_CRANE_SLEW_SWEEP, HARBOUR_CRANE_SLEW_U, HARBOUR_CRANE_SLEW_Y, HARBOUR_CRANE_TROLLEY_KEY, HARBOUR_CRANE_TROLLEY_PICK, HARBOUR_CRANE_TROLLEY_REACH, HARBOUR_CRANE_TROLLEY_Y, HARBOUR_CRANE_SPREADER_KEY } from "./textures/harbour/crane";
import { HARBOUR_CARGO_CONTAINER_KEY, HARBOUR_CONTAINER_ANCHOR_Y, HARBOUR_CONTAINERS_KEYS, HARBOUR_CONTAINERS_ANCHOR_Y, HARBOUR_CARGO_KEYS, HARBOUR_CARGO_ANCHOR_Y } from "./textures/harbour/cargo";
import { HARBOUR_SHIP_KEY, HARBOUR_SHIP_KEYS, HARBOUR_SHIP_ANCHOR_Y, HARBOUR_SHIP_BAY_OFFSETS } from "./textures/harbour/ship";
import { TERRAIN_ATLAS_KEY, TERRAIN_VARIANT_COUNTS, roadTextureKey, terrainTextureKey } from "./textures/terrain";
import { TILE_ANCHOR_Y, TILE_HEIGHT, TILE_WIDTH } from "./textures/core";
import { BATTLESHIP_KEYS, BATTLESHIP_ANCHOR_Y } from "./textures/navy/battleship";
import { NAVY_QUAY_KEY, NAVY_QUAY_DECK, NAVY_QUAY_ANCHOR_Y, NAVY_PIER_KEY, NAVY_PIER_ANCHOR_Y, NAVY_COMMAND_KEY, NAVY_COMMAND_ANCHOR_Y, NAVY_HANGAR_KEY, NAVY_HANGAR_ANCHOR_Y, NAVY_BARRACKS_KEY, NAVY_BARRACKS_ANCHOR_Y, NAVY_RADAR_KEY, NAVY_RADAR_ANCHOR_Y, NAVY_RADAR_HUB_Z, NAVY_RADAR_DISH_KEYS, NAVY_RADAR_DISH_ANCHOR_Y, NAVY_COMMAND_BEACON_Z, NAVY_FLOODLIGHT_LAMP_Z, NAVY_SIGN_BEACON_Z, NAVY_FENCE_KEY, NAVY_FENCE_ANCHOR_Y, NAVY_FLOODLIGHT_KEY, NAVY_FLOODLIGHT_ANCHOR_Y, NAVY_FLAG_KEY, NAVY_FLAG_ANCHOR_Y, NAVY_CRATE_KEY, NAVY_CRATE_ANCHOR_Y, NAVY_BOLLARD_KEY, NAVY_SIGN_KEY, NAVY_SIGN_ANCHOR_Y } from "./textures/navy/base";
import { NAVY_ROTOR_KEYS, NAVY_ROTOR_ANCHOR_Y, NAVY_ROTOR_HUB_Z, NAVY_HELIPAD_KEY, NAVY_HELIPAD_ANCHOR_Y, NAVY_HELICOPTER_KEY, NAVY_HELICOPTER_ANCHOR_Y } from "./textures/navy/aircraft";
import { NAVY_MISSILE_KEY, NAVY_MISSILE_ANCHOR_Y, NAVY_TANK_KEY, NAVY_TANK_ANCHOR_Y, NAVY_GUN_KEY, NAVY_GUN_ANCHOR_Y, NAVY_FUEL_TANK_KEY, NAVY_FUEL_TANK_ANCHOR_Y } from "./textures/navy/vehicles";
