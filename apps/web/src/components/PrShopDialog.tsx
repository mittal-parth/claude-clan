            ...
            <DialogHeader className="space-y-2 text-left">
              ...
              <DialogTitle className="flex items-center gap-2.5 text-left">
                ...
                <span className="retro text-sm text-sky-200 sm:text-base">
                  Deploy to Pull Request City
                </span>
              </DialogTitle>
              <DialogDescription className="max-w-xl text-xs leading-5 text-sky-100/55">
                Select an open pull request to sail the battleship to its dedicated worktree city and review the changes.
              </DialogDescription>
            </DialogHeader>
          </div>
        ...
        <div className="flex flex-col gap-3 p-4 sm:p-5">
          <label className="airport-search relative block">
            <Search
              ...
              aria-hidden="true"
            />
            <span className="sr-only">Search open PRs</span>
            <input
              type="search"
              value={query}
          ...
          <div className="flex items-center justify-between border-t border-white/10 pt-3 text-[8px]">
            <span className="retro text-sky-200/55">
              {prs.length} OPEN {prs.length === 1 ? "PR" : "PRS"} AVAILABLE
            </span>
            <HudButton
              type="button"
              variant="outline"
